...
Pod::Spec.new do |s|
  s.name             = 'PublicTool'
  s.version          = '0.1.0'
  s.summary          = 'A short description of PublicTool.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/TPQuietBro/PublicTool'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'TPQuietBro' => 'luoxin3116@gmail.com' }
  s.source           = { :git => 'https://github.com/TPQuietBro/PublicTool.git', :tag => s.version.to_s }
